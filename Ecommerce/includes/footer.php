        ...
        <div class="row"><!-- row Begin -->
            ...
            <div class="col-sm-6 col-md-3"><!-- col-sm-6 col-md-3 Begin -->
                ...
                <p><!-- p Start -->
                    ...
                    <strong>E-Commerece</strong>
                    <br/>Bhubaneswar
                    <br/>Odisha
                    <br/>+91-824-991-5032
                    <br/>infoshopnow@gmail.com
                    <br/><strong>Shop Now</strong>
...
<div id="copyright"><!-- #copyright Begin -->
    <div class="container"><!-- container Begin -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            ...
            <p class="pull-left">&copy; 2018 E_commerce All Rights Reserve</p>
            
        </div><!-- col-md-6 Finish -->
        <div class="col-md-6"><!-- col-md-6 Begin -->
            
            <p class="pull-right">Theme by: <a href="https://github.com/Sunitkumar132">Sunit</a></p>
